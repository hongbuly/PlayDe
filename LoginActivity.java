...
import com.example.play_de.main.login.LoginBossActivity;
import com.example.play_de.main.login.SearchPassActivity;
import com.example.play_de.main.login.SearchidActivity;
import com.example.play_de.main.login.Signup1Activity;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private TextView txt_login_searchid;
    private TextView txt_login_searchpassword;
    private TextView txt_login_boss;
    //
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eventListener();
        //
        txt_login_signup = findViewById(R.id.register);
        txt_login_searchid = findViewById(R.id.missing_id);
        txt_login_searchpassword = findViewById(R.id.missing_password);
        txt_login_boss = findViewById(R.id.president);
        ...
        txt_login_searchid.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        txt_login_searchpassword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        txt_login_boss.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(LoginActivity.this , LoginBossActivity.class);
                startActivity(intent); // 액티비티 이동
            }
        });
        //
